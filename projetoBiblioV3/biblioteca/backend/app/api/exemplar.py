...
def get_exemplar_por_id_emprestimo(db: db_dependency, exemplar_id: int, admin: user_dependecy):
...
def get_exemplar_por_id_reserva(db: db_dependency, exemplar_id: int, admin: user_dependecy):
    db_admin = db.get(Usuario, admin.get('id'))
